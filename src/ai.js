...
/**
 * Unified AI client — supports OpenAI, OpenRouter, Gemini, Anthropic, Groq, Custom
 */
...
async function chatOpenAICompat(provider, messages, overrides) {
  ...
  if (provider === 'openrouter') {
    headers['HTTP-Referer'] = 'https://github.com/whofik/telebot-agent-mcp';
    headers['X-Title'] = 'TeleBot Agent MCP';
  }
